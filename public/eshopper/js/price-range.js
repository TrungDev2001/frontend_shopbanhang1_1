...
!function ($) {
	...
	Slider.prototype = {
		...
		layout: function () {
			...
			if (this.range) {
				this.tooltipInner.text(
					this.formater(formatter.format(this.value[0])) +
					' : ' +
					this.formater(formatter.format(this.value[1]))
				);
		...
		mouseup: function (ev) {
			...
			//lọc giá theo price-range
			var price_range_min = val[0];
			var price_range_max = val[1];
